...
/*Log4Me 是一条守护线程,几乎与服务器同时开启   它一直在等待另一条服务器线程所返回的值result,连同result一起带来的还有boolean,false
 * 所以说当没有获取到result   程序会直接跳到睡眠处
 * 
 * 
 * */
